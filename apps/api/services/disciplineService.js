...
const DEFAULT_TIERS = [
  {
    tier: "Prospect",
    pointsRequired: 0,
    rewards: ["record_begins", "lock_engine_active"],
  },
  {
    tier: "Established",
    pointsRequired: 50,
    rewards: ["lender_score_visibility", "loan_waitlist_access"],
  },
  {
    tier: "Trusted",
    pointsRequired: 150,
    rewards: ["micro_loan_preview", "peer_loan_access", "phase2_early_insight"],
  },
  {
    tier: "Proven",
    pointsRequired: 350,
    rewards: ["standard_loan_access", "community_pool_access", "higher_protocol_flexibility"],
  },
  {
    tier: "Recognized",
    pointsRequired: 700,
    rewards: ["preferred_loan_terms", "phase2_asset_access_early"],
  },
  {
    tier: "Distinguished",
    pointsRequired: 1200,
    rewards: ["alternative_credit_tier", "peer_lending_lender_side", "advanced_rwa_window"],
  },
  {
    tier: "Sovereign",
    pointsRequired: 2000,
    rewards: [
      "full_behavioral_credit_profile",
      "high_value_rwa_access",
      "dynasty_lock_activation",
      "private_guidance",
    ],
  },
];
...
const ACTION_POINTS = {
  ...
  maturedDeposit: 5,
  autoRelock: 3,
  thirtyDayCleanStreak: 15,
  ninetyDayCleanStreak: 50,
  oneEightyDayCleanStreak: 120,
  taxVaultCompliance: 5,
  earlyUnlockFirst: -10,
  earlyUnlockSecond: -25,
  earlyUnlockThird: -50,
};
